                        ...
                        <div class="card-boddy pt-0">
                            <form action="" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="nomorhp" name="nomorhp" placeholder="No. HP">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input required type="password" class="form-control" id="passwordconfirm" name="passwordconfirm" placeholder="Password">
                                </div>
